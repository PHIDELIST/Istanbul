                                        ...
                                        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                            ...
                                            <div className="mt-6">
                                                <button
                                                    ...
                                                    className="flex items-center justify-center rounded-md border border-transparent bg-slate-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-black"
                                                >
                                                    <Link
                                                        to="/checkout"
